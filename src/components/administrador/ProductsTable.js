          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.slug}>
                ...
                <td className="p-2">
                  <Link href={`/admin/edit/${product.slug}`} className="rounded bg-green-400 p-2 text-white">
                    Editar
                  </Link>

                  <Link href={`/admin/delete/${product.slug}`} className="rounded bg-red-400 p-2 text-white">
                    Eliminar
                  </Link>
                </td>
              </tr>
